...
vec_model = gensim.models.Word2Vec.load('model/word2vec_include.model')
wordvec_size = len(vec_model['账单'])
print("成功导入词向量， 维度=", wordvec_size)
...
def word2vec_sim(sentence_vec, simlist_vec, threshold=0.5):
    """
    :param sentence_vec: 单个句子的向量 ('', array)
...
if __name__ == '__main__':
    with open("app/analyzers/smart_text_analyzer/model/把握需求", 'rb') as f:
